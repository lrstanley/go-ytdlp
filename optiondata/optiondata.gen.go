...
var (
	...
	optionUpdate = &Option{
		...
		URLs: []*OptionURL{
			{
				Name: "Update Notes",
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#update",
			},
		},
		DefaultFlag: "--update",
		Executable:  true,
		...
		URLs: []*OptionURL{
			{
				...
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#differences-in-default-behavior",
			},
		},
		...
		URLs: []*OptionURL{
			{
				...
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#output-template",
			},
		},
		DefaultFlag: "--output",
		...
		URLs: []*OptionURL{
			{
				...
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#format-selection",
			},
			{
				Name: "Filter Formatting",
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#filtering-formats",
			},
			{
				Name: "Format Selection Examples",
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#format-selection-examples",
			},
		},
		DefaultFlag: "--format",
		...
		URLs: []*OptionURL{
			{
				...
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#sorting-formats",
			},
			{
				Name: "Format Selection Examples",
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#format-selection-examples",
		...
		URLs: []*OptionURL{
			{
				...
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#modifying-metadata",
			},
			{
				Name: "Modifying Metadata Examples",
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#modifying-metadata-examples",
			},
		},
		...
		URLs: []*OptionURL{
			{
				...
				URL:  "https://github.com/yt-dlp/yt-dlp/blob/2024.07.08/README.md#extractor-arguments",
			},
		},
